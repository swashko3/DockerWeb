...
namespace DockerWebDbService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // NON Docker-Compose value for connection string, pulls from appsettings.json 
            if (connection == null)
            {
